...
async function setupDatabase() {
  ...
  try {
    ...
    const questions = [
      ...
      {type: 'fill_blank', text: 'El niño ______ al parque todos los días.', exp: 'Verbo ir en presente', opts: null, ans: 'va', ord: 16},
      {type: 'fill_blank', text: '______ importante estudiar para el examen.', exp: 'Verbo ser en forma impersonal', opts: null, ans: 'Es', ord: 17},
      {type: 'fill_blank', text: 'La película fue ______ e interesante.', exp: 'Adjetivo derivado de "entretener"', opts: null, ans: 'entretenida', ord: 18},
      {type: 'fill_blank', text: 'Si ______ dinero, viajaría al extranjero.', exp: 'Verbo tener en condicional', opts: null, ans: 'tuviera', ord: 19},
      {type: 'fill_blank', text: 'El ______ explica la lección claramente.', exp: 'Profesional que enseña', opts: null, ans: 'profesor', ord: 20},
      {type: 'fill_blank', text: '______ no me gusta ese tipo de música.', exp: 'Pronombre personal para enfatizar', opts: null, ans: 'A mí', ord: 21},
      {type: 'fill_blank', text: 'Ellos ______ de vacaciones la próxima semana.', exp: 'Verbo estar en futuro', opts: null, ans: 'estarán', ord: 22},
      {type: 'fill_blank', text: 'La ______ es muy hermosa y colorida.', exp: 'Planta con pétalos', opts: null, ans: 'flor', ord: 23},
      {type: 'fill_blank', text: '______ hemos decidido ir a la playa mañana.', exp: 'Pronombre plural de primera persona', opts: null, ans: 'Nosotros', ord: 24},
      {type: 'fill_blank', text: 'Fue un ______ muy importante en su vida.', exp: 'Sinónimo de evento o hecho', opts: null, ans: 'suceso', ord: 25},
      {type: 'fill_blank', text: 'La ______ al problema fue muy simple.', exp: 'Respuesta a un problema', opts: null, ans: 'solución', ord: 26},
      {type: 'fill_blank', text: '______ vez termina el trabajo, descansa un poco.', exp: 'Adverbio de frecuencia', opts: null, ans: 'Cada', ord: 27},
      {type: 'fill_blank', text: 'Yo ______ fútbol con mis amigos el sábado.', exp: 'Verbo jugar en futuro', opts: null, ans: 'jugaré', ord: 28},
      {type: 'fill_blank', text: 'El ______ precede al sustantivo en español.', exp: 'Palabra gramatical que acompaña al sustantivo', opts: null, ans: 'artículo', ord: 29},
      {type: 'fill_blank', text: '______ escribo esta carta con mucho cuidado.', exp: 'Indicador de momento temporal', opts: null, ans: 'Hoy', ord: 30},
      {type: 'fill_blank', text: 'La ______ es un derecho fundamental.', exp: 'Lo opuesto a esclavitud', opts: null, ans: 'libertad', ord: 31},
      {type: 'fill_blank', text: 'Ellas ______ mañana para visitarnos.', exp: 'Verbo venir en futuro', opts: null, ans: 'vendrán', ord: 32},
      {type: 'fill_blank', text: 'El ______ duerme sobre el sofá.', exp: 'Felino doméstico', opts: null, ans: 'gato', ord: 33},
      {type: 'fill_blank', text: '______ de verdad esto es sorprendente.', exp: 'Expresión que enfatiza', opts: null, ans: 'De verdad', ord: 34},
      {type: 'fill_blank', text: 'Todos ______ cumplir con sus responsabilidades.', exp: 'Verbo que expresa obligación', opts: null, ans: 'deben', ord: 35},
