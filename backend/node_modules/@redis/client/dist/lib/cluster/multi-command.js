...
class RedisClusterMultiCommand {
    ...
    #isReadonly = true;
    #keyPrefix;
    constructor(executeMulti, executePipeline, routing, typeMapping, keyPrefix) {
        ...
        this.#firstKey = routing === undefined ? undefined : (0, parser_1.prefixKey)(keyPrefix, routing);
